...
if (isset($_SESSION["user"])) {
    ...
    if ($_SESSION["user"]["user_type_id"] == "1" || $_SESSION["user"]["user_type_id"] == "2" || $_SESSION["user"]["user_type_id"] == "3" || $_SESSION["user"]["user_type_id"] == "4") {
        ...
        // $clentIncomeBusiness = $_POST["clentIncomeBusiness"];
        ...
        //  else if (!isset($_FILES["clientNicFrontPhoto"])) {
        ...
        if (empty($clientEmpName)) {
            ...
            return;
        } else if (!preg_match('/^\$?(0|[1-9]\d*)(\.\d{1,2})?$/', $clentIncomeEmp)) {
            echo "Invalid Other Income";
            return;
        } else if (!isset($clentIncomeOther) || $clentIncomeOther === '') {
            echo "Please Enter Other Income";
            return;
        } else if (!preg_match('/^\$?(0|[1-9]\d*)(\.\d{1,2})?$/', $clentIncomeOther)) {
            echo "Invalid Other Income";
            return;
        }

        // else if(!is_numeric($clentIncomeBusiness)){
        //     echo "Invalid Business Income";
        //     return;
        // } 
        // else if (empty($clentIncomeBusiness)) {
        //     echo "Please Enter Business Income";
        //     return;
        // } 
        // else if (empty($clentIncomeOther)) {
        //     echo "Please Enter Other Income";
        //     return;
        // } 
        // else if (empty($clientTotalIncome)) {
        //     echo "Please Enter Total Income";
        //     return;
        // } 
        else if (empty($clientCostLiving)) {
            echo "Please Enter Living cost";
            return;
        } else if (!preg_match('/^\$?(0|[1-9]\d*)(\.\d{1,2})?$/', $clientCostLiving)) {
            echo "Invalid Other Income";
            return;
        }
        // else if (empty($clientLoanRepayment)) {
        //     echo "Please Enter Loan Tepayment";
        //     return;
        // } 
        else if (!isset($clientLoanRepayment) || $clientLoanRepayment === '') {
            echo "Please Enter Loan Repayment";
            return;
        } else if (!preg_match('/^\$?(0|[1-9]\d*)(\.\d{1,2})?$/', $clientLoanRepayment)) {
            echo "Invalid Other Income";
            return;
        }
        // else if (empty($clientNetIncome)) {
        //     echo "Please Enter Net Income";
        //     return;
        // } 
        else {
            ...
            if (empty($clientItemRequiredtype)) {
                ...
                $clientNicFrontPhotoPath = "resources/add-image.png";
                $clientNicBackPhotoPath = "resources/add-image.png";
